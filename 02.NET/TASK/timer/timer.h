...
#define GENERAL_TIM3_Period (100) // 100us一次中断
#define GENERAL_TIM3_Prescaler 72 // 时钟预分频数

#define GENERAL_TIM4_Period (1000) // 100us一次中断
#define GENERAL_TIM4_Prescaler 71  // 时钟预分频数

#define GENERAL_TIM5_Period (7200)  // 1ms一次中断
#define GENERAL_TIM5_Prescaler 1 // 时钟预分频数

#define GENERAL_TIM6_Period 1000	  // 100us一次中断
#define GENERAL_TIM6_Prescaler 72 // 时钟预分频数
